...
const ContactEmailModal = ({ isOpen, onClose, emailData }) => {
    ...
    <ModalOverlay onClick={onClose}>
      <ModalContent onClick={(e) => e.stopPropagation()}>
        ...
        <ModalBody>
          <EmailInfo>
            <Mail size={20} />
            <EmailText>{emailData.email}</EmailText>
          </EmailInfo>
          <Description>Your message is ready to send. Select your preferred email service:</Description>
